...
function FeaturesSection({ active }) {
        ...
        <div className="max-w-[1280px] mx-auto w-full">
          <div className="text-center mb-12">
            <M.span
              ...
              style={{ background: 'rgba(124,58,237,0.1)', color: '#7C3AED' }}>Features</M.span>
            <M.h2
            ...
            {feats.map((f, i) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="font-display font-bold text-[18px] text-ink leading-snug mb-2">{f.title}</div>
                  <div className="text-[14px] text-mute leading-relaxed">{f.desc}</div>
