// SECTION 5 — Gemini Model Intelligence
function ModelsSection({ active }) {
  const { M, Section, EASE, Icons } = window.PA;

  const tiers = [
    {
      name: 'Gemini Pro',
      tag: 'Deep Reasoning',
      tone: '#7C3AED', tone2: '#A855F7',
        ...
        <div className="max-w-[1280px] mx-auto w-full">
          <div className="text-center mb-10">
            <M.span
              ...
              style={{ background: 'rgba(124,58,237,0.1)', color: '#7C3AED' }}>Mixed-Model Strategy</M.span>
            <M.h2
            ...
            >
              <span style={{ color: 'rgb(194, 177, 219)' }}>Built for Teams That </span><span className="text-gradient">Right AI</span><span style={{ color: 'rgb(177, 166, 193)' }}> for Every Task</span>
            </M.h2>
          </div>

          {/* Floating cards with depth */}
          <div className="relative grid grid-cols-3 gap-6 perspective-1000" style={{ perspective: '1200px' }}>
            {tiers.map((t, i) => (
              <M.div key={i}
              ...
              >
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="font-display font-extrabold text-2xl text-ink">{t.name}</div>
                    <div className="text-sm font-medium mt-0.5" style={{ color: t.tone }}>{t.tag}</div>
                    <p className="text-[13px] text-mute mt-3 leading-relaxed">{t.blurb}</p>
          ...
          <M.div
            ...
            className="mt-10 mx-auto max-w-[680px] relative"
          >
            <M.div
...
window.ModelsSection = ModelsSection;
